...
> and issue tracker for **Dr_ClaudeGoode**.

---

## How to use this document

- This is the living help-desk for repo operations, CI/CD, bugs, and blockers for Dr_ClaudeGoode.
...
```
Issues/
├── Dr_ClaudeGoode_ISSUES.md       (this file — the ledger)
